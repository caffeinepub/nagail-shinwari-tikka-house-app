...
export class Backend implements backendInterface {
    ...
    async getRestaurantProfile(): Promise<RestaurantProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getRestaurantProfile();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRestaurantProfile(arg0: RestaurantProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRestaurantProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
